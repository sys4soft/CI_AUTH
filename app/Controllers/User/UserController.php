...
class UserController extends BaseController
{
    ...
    {
        // check if there are validation erros in session
        $data = [];
        ...
        $validation = $this->validate([
            'text_username' => [
                ...
                'errors' => [
                    ...
                    'valid_email' => 'O campo {field} tem que ser um email válido.'
                ]
            ],
            'text_passwrd' => [
                'label' => 'Password',
                ...
                'errors' => [
                    ...
                    'regex_match' => 'A password tem que ter uma minúscula, uma maiúscula e um digito.'
                ]
            ]
        ]);
        ...
        $validation = $this->validate([
            ...
            'text_repeat_passwrd' => [
                ...
                'errors' => [
                    ...
                    'max_length' => 'O campo {field} tem que ter, no máximo, {param} caracteres.',
                    'regex_match' => 'A password tem que ter uma minúscula, uma maiúscula e um digito.',
                    'matches' => 'A repetição da password deve ser igual à password.'
                ]
            ]
        ]);
    ...
    public function recover_password_submit()
    {
        ...
        <p>Para concluir o processo de recuperação da password, clique no link abaixo.</p>
        <p>
        <a href="' . $purl .'">Recuperar password</a>
        </p>
        ';
        $email->setMessage($message);
        $email->send();
    ...
    public function user_recover_password_define_submit()
    {
        ...
        /* 
        http://localhost/ci_auth/public/index.php/user_recover_password_check/fJDPIEegxExL
        */
        ...
        $users = new UserModel();
        $results = $users->update_user_password($id_user, $this->request->getPost('text_passwrd'));
